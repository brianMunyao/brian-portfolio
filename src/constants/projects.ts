...
Built with React Native for cross-platform mobile compatibility and Next.js for the admin dashboard, the platform integrates Firebase for real-time data synchronization, Stripe for secure payment processing, and custom analytics for business insights. The solution handles everything from membership management to event ticketing with QR code generation and real-time check-ins.`,
	...
	{
		id: 'rentmate',
		title: 'RentMate - Comprehensive Property Management System',
		description:
			'A property management platform that streamlines landlord operations through efficient rent tracking, tenant management, financial reporting, and monthly cycle automation. Built for scalability with modern web technologies.',
		fullDescription:
			'RentMate is a comprehensive property management solution designed to simplify landlord operations and maximize rental income efficiency. The platform provides end-to-end management capabilities from property setup to financial reporting, featuring automated monthly cycles, intelligent payment tracking, and detailed tenant management. Built with Next.js 15 and TypeScript, the system offers real-time data synchronization, automated financial calculations, and intuitive dashboards that provide actionable insights for property portfolio management. The platform handles complex scenarios like partial payments, security deposits, lease management, and multi-property operations with sophisticated balance tracking and payment timing analysis.',
		color: '#059669',
		main_image:
			'https://res.cloudinary.com/breivaco/image/upload/v1751879381/simplefolio/rentmate/rentmate-dashboard1_q05tgn.png',
		...
		status: 'Prototype',
		is_featured: true,
		web_link: 'https://rentmatev2.vercel.app',
		features: [
			'Multi-property management with detailed floor and room configuration',
			'Comprehensive tenant management with lease tracking and payment history',
			'Intelligent payment recording with conditional validation for different payment types',
			'Automated monthly cycle management with financial summaries and balance calculations',
			'Advanced payment tracking with timing analysis (on-time, late, advance payments)',
			'Security deposit management with one-time payment handling',
			'Real-time dashboard with occupancy rates, revenue analytics, and balance warnings',
			'Bulk operations for room management and tenant assignments',
			'Automated lease end processing with security deposit handling',
			'Comprehensive financial reporting with month-over-month comparisons',
			'Responsive design optimized for desktop and mobile property management',
			'Type-safe API layer with comprehensive error handling and validation',
		],
		achievements: [
			'Designed and implemented scalable database schema supporting complex rental scenarios',
			'Built responsive UI with shadcn/ui components and Tailwind CSS for optimal user experience',
			'Implemented sophisticated payment validation system with conditional schema validation',
			'Created automated monthly cycle management reducing manual administrative work by 80%',
			'Developed intelligent balance calculation system handling partial payments and deposits',
			'Built comprehensive tenant assignment system with room availability tracking',
			'Implemented real-time data synchronization with optimistic updates for better UX',
			'Created modular component architecture enabling rapid feature development',
			'Designed type-safe database operations with Drizzle ORM and PostgreSQL',
			'Built conditional Zod validation schemas for different payment types',
		],
		technologies: [
			'Next.js',
			'TypeScript',
		...
		webImages: [
			'https://res.cloudinary.com/breivaco/image/upload/v1751879382/simplefolio/rentmate/rentmate-tenants_zajlyh.png',
			'https://res.cloudinary.com/breivaco/image/upload/v1751879381/simplefolio/rentmate/rentmate-dashboard1_q05tgn.png',
			'https://res.cloudinary.com/breivaco/image/upload/v1751879381/simplefolio/rentmate/rentmate-dashboard_c3cbxd.png',
		],
	},
	{
		is_featured: true,
